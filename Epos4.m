classdef Epos4 < handle
    ...
    methods
        ...
        function res = SetOperationMode(obj, mode, varargin)
            ...
            switch mode
                ...
                case OperationModes.PositionMode
                    Values = 8; % torque mode (8 not -1)
                    
                case OperationModes.VelocityMode
                    Values = -2;
                    
                case OperationModes.CurrentMode
                    Values = 10;% 'torque' mode (10 not -3), actually current mode
        ...
        function res = MotionWithCurrent(obj, current)
            ...
            % E. Yime, 2015
            %
%%comment to increase runtime speed (1.3X) ---
%             if (obj.IsInErrorState)
%                 obj.Enable = 0;
%                 error('you can not move a motor when it is in error state');
%             end
...
%%-----
        ...
        function res = SetWithAnalog(obj, varargin)
            ...
            % A. Yurkewich, 2020
            %
            analogOutputPin = cell2mat(varargin(1));
            value = cell2mat(varargin(2));
        ...
        function res = SetWithDigital(obj, varargin)
            ...
            % use it as:
            %
            % >> Motor1.SetWithAnalog(digitalOutputPin, value)
            %
            % A. Yurkewich, 2020
            %
            digitalOutputPin = cell2mat(varargin(1));
            value = cell2mat(varargin(2));
            res = SetDigital( obj.Handle, obj.NodeID, digitalOutputPin, value );
        end 
    end
end
